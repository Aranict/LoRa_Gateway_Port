...
uint32_t lgw_time_on_air(struct lgw_pkt_tx_s *packet) {
    ...
    double Tsym, Tpreamble, Tpayload, Tfsk, zx; //CHANGE-KIERAN zx so that pow will compile without error
    zx = 2; //CHANGE-KIERAN initialise as variable instead of literal
    if (packet == NULL) {
